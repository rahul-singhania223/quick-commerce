...
export default function InventoryForm({ data }: Props) {
  ...
  return (
    <div className="flex gap-5 justify-between p-6 mt-0">
      <div className="flex-1 rounded-lg shadow-sm bg-white p-4 space-y-6 h-fit max-h-screen overflow-y-auto">
        <div className="relative">
          <Label className={cn("mb-2 text-base text-foreground", {})}>
            Select Product:
          </Label>
          <div className="flex items-center border rounded-lg h-11 px-3 focus-within:border-primary/50 focus-within:ring-1 focus-within:ring-primary">
      ...
      <div className="flex-1 rounded-lg shadow-sm bg-white p-4 space-y-4 h-fit">
        {/* PRICE */}
        <div>
          <Label
            className={cn("mb-2 text-base text-foreground", {
        ...
        <Button
          ...
          className="h-12 text-base mt-6 cursor-pointer w-full max-w-xs"
        >
