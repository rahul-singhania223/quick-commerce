  ...
  return (
    ...
    >
      <SelectTrigger
        ...
        className="w-fit border-none shadow-none hover:bg-muted relative z-100"
      >
        <SelectValue className="w-full space-x-1" />
      </SelectTrigger>
      <SelectContent position="popper" className="">
        <SelectItem value="OPEN" className="space-x-1">
          <div className="size-2 bg-green-500 rounded-full" />
          <span className="text-sm text-body font-medium">Online</span>
        </SelectItem>
        <SelectItem value="CLOSED" className="space-x-1">
          <div className="size-2 bg-red-500 rounded-full" />
          <span className="text-sm text-body font-medium">Offline</span>
        </SelectItem>
      </SelectContent>
    </Select>
  );
